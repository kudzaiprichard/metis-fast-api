...
Revision ID: e1bb89a5ff07
Revises: 
Create Date: 2026-03-08 01:28:20.091920
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'DOCTOR', name='role_enum'), nullable=False),
