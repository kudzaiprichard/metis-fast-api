...
def _register_routers(app: FastAPI) -> None:
    ...
    from src.modules.patients import patient_router, similar_patients_router
    ...
    app.include_router(similar_patients_router, prefix="/api/v1/similar-patients", tags=["Similar Patients"])
